...
- Erstellen Sie ein React-Projekt mit create-vite: `npm init --yes vite@latest reactapp2.client -- --template=react-ts`..
- Projektdatei (`reactapp2.client.esproj`) erstellen.
